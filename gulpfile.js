...
var
  watch = require('./' + yeoman.app + '/bower_components/semantic/tasks/watch'),
  build = require('./' + yeoman.app + '/bower_components/semantic/tasks/build')
  ;
...
gulp.task('copy:videos', function () {
  return gulp.src(yeoman.app + '/videos/**/*')
